...
public class DialogEditor: AbstractEditor, ResourceEditor {
    ...
    public let createMenuTitle: String? = "Add Dialog Item"
...
extension DialogEditor: NSTableViewDelegate, NSTableViewDataSource {
