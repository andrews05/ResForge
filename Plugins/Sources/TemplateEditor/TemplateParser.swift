...
public class TemplateParser {
    ...
    public init(template: Resource, manager: RFEditorManager, basic: Bool = false) {
    ...
    public func parse() throws -> [BaseElement] {
    ...
    private func process() throws -> [BaseElement] {
        ...
        case "TMPL":
            ...
            guard let template = manager.findResource(type: .template, name: element.label, currentDocumentOnly: false) else {
