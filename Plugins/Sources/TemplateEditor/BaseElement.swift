...
public class BaseElement: ValueTransformer, NSTextFieldDelegate {
    ...
    public func readData(from reader: BinaryDataReader) throws {}

    /// Write the value of the field to the stream.
    public func writeData(to writer: BinaryDataWriter) {}
}
...
public protocol FormattedElement where Self: BaseElement {
